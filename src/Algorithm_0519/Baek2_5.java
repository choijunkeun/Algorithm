...
public class Baek2_5 {
    public static void main(String[] args) {
        ...
        // 45분 아래일 때는 시간이 1 감소되어야 한다.
        // ex : 40분일 경우에는 40분이 깎이고 5분이 더 남아있는데 60분에서 5분 앞으로니까 55가 나와야함. 따라서 (45분-현재분)을 60에서 빼줘야한다.  60 - (45-40) = 55
        if (minute < 45) {
            hour -= 1;
            minute = 60 - (45 - minute);

            //만약 시간이 0시일 경우에는 23시가 되어야하니 시간을 23시로 바꿔준다.
            if(hour<0) {
                hour = 23;
            }
